...
namespace Features.Garage
{
    ...
    public sealed class GarageSetup
    {
        ...
        public void Initialize(
            ...
            ComposeUnitUseCase.IUnitCompositionDataProvider compositionDataProvider,
            ValidateRosterUseCase.IRosterValidationProvider rosterValidationProvider)
        {
            ...
            // Domain 레이어는 static class (UnitComposition, CostCalculator)이므로 인스턴스화 불필요
            InitializeGarage = new InitializeGarageUseCase(persistencePort, eventBus);
            ComposeUnit = new ComposeUnitUseCase(compositionDataProvider);
