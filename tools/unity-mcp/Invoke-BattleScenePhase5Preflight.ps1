param(
    [string]$BaseUrl,
    [string]$OutputPath = "artifacts/unity/game-flow/battle-scene-phase5-preflight.json",
...
$singleClientBaselinePath = Join-Path $repoRoot "artifacts/unity/game-flow/battle-scene-natural-victory-flow-closeout.json"
$placementContractPath = Join-Path $repoRoot "artifacts/unity/game-flow/battle-scene-placement-contract-smoke.json"
