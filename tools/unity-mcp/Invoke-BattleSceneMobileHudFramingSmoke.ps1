param(
    [string]$BaseUrl,
    [string]$Owner = "BattleSceneMobileHudFraming",
    [ValidateSet("None", "Defeat", "Victory", "NaturalVictory")]
    [string]$ResultMode = "NaturalVictory",
    [string]$OutputPath = "artifacts/unity/game-flow/battle-scene-mobile-hud-framing-smoke.json",
    [string]$PlacementOutputPath = "artifacts/unity/game-flow/battle-scene-mobile-hud-placement-source.json",
    [string]$ScreenshotPath = "artifacts/unity/game-flow/battle-scene-mobile-hud-framing.png",
