param(
    ...
    [string]$Owner = "BattleSceneUIUX",
    [string]$OutputPath = "artifacts/unity/current/battle-scene-placement-smoke.json",
...
$result = [PSCustomObject][ordered]@{
    ...
    evidence = [PSCustomObject][ordered]@{
        migrationRequired = "This legacy BattleScene placement smoke targeted UGUI/Canvas objects and is intentionally disabled. Replace it with a UIDocument/VisualElement UITK smoke before using this lane for acceptance."
