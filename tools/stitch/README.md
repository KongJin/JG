...
- fetch one Stitch screen's HTML, screenshot, and extracted image assets into `artifacts/stitch/`
...
Fetch one screen but skip extracting internal image assets:

```bash
npm run stitch:fetch:screen -- --project 15511739434163767886 --screen 2225f2733de747d298f1e0c445fbb47c --skip-assets
```
