...
| Plan Mode / Codex 운영 규칙 | [`/docs/index.md`](docs/index.md)에서 current owner 확인 후 `rule-operations` route와 repo owner 문서 |
| Codex 코딩 가드레일 / LLM coding 오류 방지 | [`/docs/owners/operations/codex_coding_guardrails.md`](docs/owners/operations/codex_coding_guardrails.md) |
| 문서 운영 / closeout 상위 원칙 | [`/docs/owners/operations/document_management_workflow.md`](docs/owners/operations/document_management_workflow.md) |
| 코딩 규칙, 아키텍처 | [`/docs/owners/operations/skill_routing_registry.md`](docs/owners/operations/skill_routing_registry.md)에서 repo owner fallback과 rule skill route 확인 |
| 게임 컨셉, 디자인 | [`/docs/owners/design/game_design.md`](docs/owners/design/game_design.md) |
