...
이 문서는 `docs/` 탐색용 인덱스다. 상세 규칙의 공식 진입점은 [`../CLAUDE.md`](../CLAUDE.md), 진행 상황 SSOT는 [`plans/progress.md`](./plans/progress.md)다.
...
- `active`: [`mcp_improvement_plan.md`](./plans/mcp_improvement_plan.md) - Unity MCP 정리 방향
...
- 전역 진입점과 상위 링크는 [`../CLAUDE.md`](../CLAUDE.md)에서 시작한다.
- feature 씬 계약과 runtime contract는 `Assets/Scripts/Features/*/README.md`를 우선한다.
