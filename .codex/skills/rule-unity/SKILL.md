---
name: rule-unity
description: meta GUID, 씬 직렬화, 프리팹, Unity API, MCP, CLI, 컴파일 에러, 플레이 모드 관련 질문 시 이 스킬 사용. "씬 직렬화", "프리팹 관리", "스크립트 리네임", "컴파일 에러 체크", "플레이 모드 테스트", "빌드", "batchmode" 등을 묻는다면 항상 이 스킬을 사용하세요.
---
