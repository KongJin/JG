...
description: "검증 규칙. Triggers: Clean Levels, static-clean, compile-clean, runtime-smoke-clean, webgl-build-clean, LayerDependencyValidator, 검증 통과."
---
...
JG repo에서는 `AGENTS.md`, `docs/index.md`, acceptance/playtest owner docs를 먼저 확인한다.
이 skill은 generic clean level fallback/reference다.
