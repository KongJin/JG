...
3. Read `docs/ops/unity_ui_authoring_workflow.md` for Unity UI/UX authoring routes, forbidden paths, and evidence gates.
4. Read `docs/ops/cohesion_coupling_policy.md` when owner boundaries, responsibility split, runtime contract, or hidden dependency matters.
